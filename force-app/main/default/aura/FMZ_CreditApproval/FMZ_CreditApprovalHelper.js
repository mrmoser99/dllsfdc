...
console.log('enter pre prop ' + value + ' fieldName : ' + fieldName);
  ...
  console.log('done prepop')    ;
    ...
    if (fieldName == "genesis__Account__c"){
      //this means all is loaded and we can fastpath submit for approval
      if (component.get("v.autoMode") ){
        component.set("v.processing", true);
...
console.log('financed amount is: ' + component.find("inputFieldFinance").get("v.value"));
    if (
      ...
      component.find("inputFieldFinance").get("v.value") == "" || component.find("inputFieldFinance").get("v.value") == "0"
    ) {
