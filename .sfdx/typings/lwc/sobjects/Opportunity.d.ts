...
declare module "@salesforce/schema/Opportunity.cllease__TrackingNumber__c" {
  const cllease__TrackingNumber__c:string;
  export default cllease__TrackingNumber__c;
}
